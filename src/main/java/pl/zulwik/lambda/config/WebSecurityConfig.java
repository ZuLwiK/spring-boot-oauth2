package pl.zulwik.lambda.config;
...
import pl.zulwik.lambda.oauth2.CustomOAuth2UserService;
import pl.zulwik.lambda.oauth2.CustomOidcUserService;
import pl.zulwik.lambda.oauth2.OAuth2AccessTokenResponseConverterWithDefaults;
